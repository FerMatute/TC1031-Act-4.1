...
// We create the UnweightedGraph class
...
// We create the UMatrixGraph class
template<class Vertex>
...
// Method to obtain the index of the matrix
template <class Vertex>
...
// Method to add an Edge on to the matrix
template <class Vertex>
...
// Method returns the amount inside the matrix
template <class Vertex>
bool UMatrixGraph<Vertex>::containsVertex(Vertex v) const {
	return (indexOf(v) != -1);
}

// Method returns the amount of vertexes
template <class Vertex>
...
// We define the UListGraph class
template<class Vertex>
...
// toString returns the UListGraph like a string
template <class Vertex>
...
/* We declare the Depth First Search
*
* Complexity O log(n)
*
*/
